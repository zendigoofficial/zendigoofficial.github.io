(() => {
  ...
  function saveProgress(){localStorage.setItem(STORAGE_KEY,JSON.stringify({generation,bestScore,bestScorePilot,bestScoreGeneration,bestFitness:Number.isFinite(bestFitness)?bestFitness:0,fitnessVersion:FITNESS_VERSION,brain:bestBrain?.toJSON()||null,history:generationHistory}));}
